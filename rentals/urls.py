...
from .views import user_logout,read_json, single_json, user_list, user_detail, venue_list, venue_detail, event_list, event_detail, ticket_list, ticket_detail, transaction_list, transaction_detail, accesscontrol_list, accesscontrol_detail, eventfeedback_list, eventfeedback_detail, report_list, report_detail, discount_list, discount_detail, eventorganizer_list, eventorganizer_detail, department_list, department_detail, country_list, country_detail, activitylogs_list, activitylogs_detail
...
urlpatterns = [
    ...
    path('activitylog', activitylogs_list, name='activitylogs-list'),
