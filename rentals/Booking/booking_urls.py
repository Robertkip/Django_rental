...
from .booking_views import booking_create, booking_list, booking_detail, booking_by_event, create_booking_by_event


urlpatterns = [
    path('booking/store/<int:event_id>/', create_booking_by_event, name='create-booking-by-event'),
